...
const CheckOutTable = ({ cartItems, isloading }) => {
        ...
        <>
          {cartItems.length === 0 ? (
            <div className="flex items-center justify-center">
              <h2 className="mt-5 font-bold text-red-500 text-3xl font-nunito">
                No Items on Cart
              </h2>
            </div>
          ) : (
                  ...
                  <div className="hidden lg:flex bg-[#F4F4F4A6] rounded-xl  lg:justify-between  p-3">
                    ...
                    <div className="">
                      ...
                      <p className="text-[#6D6D6D] text-xs font-medium">
                        Product Tags: {product?.category?.category_name}
                      </p>
  ...
  `}
                    ...
                    <div className="flex items-center justify-center">
                      <button
                        onClick={() => {
                          handleRemove(product._id, product.quantity);
                        }}
  ...
  `}
                    ...
                    <div className="flex flex-col items-center ">
                      <h2 className="text-[#084C4E] text-lg font-medium">
                        Price
                      </h2>
